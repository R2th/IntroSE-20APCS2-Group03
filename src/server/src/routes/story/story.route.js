...
router.put("/story/:storyId", verifyToken, upload.single("story"), storyController.updateStory);
router.delete("/story/", verifyToken, storyController.deleteStory);
router.get("/story/:storyId", storyController.getStoryByStoryId);
router.post("/story/", verifyToken, upload.single("story"), storyController.createStory);
