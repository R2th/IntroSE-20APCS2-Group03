...
Source code có thể tham khảo tại: https://github.com/ngocthai69/ViewPagerState


-----


Trên đây là một vài hướng dẫn nhỏ về việc lưu trữ các Fragment của ViewPager mà mình tìm hiểu được, mong nhận được ý kiến đóng góp của các bạn.