...
*Cho dãy số $A$ gồm $n$ phần tử $a_1, a_2, \dots, a_n \ ($với $n \le 10^6);$ hãy xác định dãy con tăng ngặt dài nhất của dãy số đã cho?*
...
- [Competitive Programming 3 - Steven Halim & Felix Halim](https://github.com/prasadgujar/CompetitiveProgramming/blob/master/book/Competitive%20Programming%203.pdf).
