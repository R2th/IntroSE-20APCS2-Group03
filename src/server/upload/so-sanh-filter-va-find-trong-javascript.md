...
Method "startsWith ES6" các bạn có thể xem nó được phát triển từ tời điểm nào kể từ khi ES6 tới ES11 giai đoạn 04.
...
```
Output: Mọi người chạy code trên console của trình duyệt sẽ thấy kết quả nhé !!!

Như vậy là xong, mặc dù bài viết này khá dễ nhưng sẽ giúp các bạn mới học javascript hiểu hơn về method trong array ES6.