...
Collatz đưa ra giả thuyết rằng: Với một số nguyên dương $X,$ nếu $X$ chẵn thì gán $X = \frac{X}{2},$ ngược lại thì gán $X = 3.X + 1$. Tiếp tục làm như vậy thì sau một số hữu hạn bước, ta sẽ thu được số $1$.
