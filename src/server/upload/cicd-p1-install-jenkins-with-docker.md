# **Install Jenkins with Docker 🐳 🐳 🐳**
  ...
  ![](https://images.viblo.asia/cd2d3469-7c6e-487a-89ff-17535659ee34.png)
...
at `localhost:8080`, and unlock jenkins using password:
  ...
  ![](https://images.viblo.asia/54f1d2a7-7713-47e7-8b42-7f02850ab231.jpeg)
...
and `Create Admin User`. `Jenkins` ready to use 🤟 🤟 🤟.
  ...
  ![](https://images.viblo.asia/3ec6d88a-986c-4dfa-8ddc-11cc0ac7618d.png)

  And we can install `BlueOcean` plugins (GUI for CI/CD Pipeline)

  ![](https://images.viblo.asia/03acec0e-a50b-40cf-89a1-5670b4b159b4.png)
