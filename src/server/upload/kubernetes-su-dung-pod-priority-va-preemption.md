# Mở đầu
Như chúng ta đã biết, Kubernetes là một hệ thống mã nguồn mở nổi tiếng với việc có thể triển khai các ứng dụng đã được container hóa một cách nhóng và đặc biệt là có thể mở rộng khối lượng công việc một cách dễ dàng. Nó chia tỷ lệ khối lượng công việc của bạn dựa trên việc sử dụng tài nguyên của chúng. Khi khối lượng công việc được tăng lên, nhiều bản sao (replicas) của ứng dụng có thể được tạo ra.
