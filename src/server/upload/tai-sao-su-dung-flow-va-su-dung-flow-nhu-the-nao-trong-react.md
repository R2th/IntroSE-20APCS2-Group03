...
Bài viết mang tính chất tham khảo, hiện tại đội ngũ Facebook đã bỏ rơi Flow để theo TypeScript [https://github.com/facebook/jest/pull/7554](https://github.com/facebook/jest/pull/7554)
...
dể đặt ràng buộc type trong Javascript hay React chúng có những 3 tên tuổi nổi bật Typescript, PropTypes, Flow.
...
```
Để init file **Để init file .flowconfig**
