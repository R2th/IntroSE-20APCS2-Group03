# 1. Use Intention-Revealing Names (Sử dụng tên bộc lộ mục đích)
...
![](https://images.viblo.asia/3dd9bde6-0429-46a9-993b-03a73fb47fb5.png)
...
```
# 2. Avoid Disinformation (Tránh sai lệch thông tin)
...
# 3. Make Meaningful Distinctions (Làm cho sự riêng biệt trở nên rõ ràng)
![](https://images.viblo.asia/03894bdd-7dc3-4f47-b818-bccf1cc51995.png)
...
# 4. Use Pronounceable Names (Sử dụng tên đọc được)
...
# 5. Use Searchable Names (Sử dụng tên tìm kiếm được)
...
# 7. Avoid Mental Mapping (Tránh ánh xạ tinh thần)
...
```
# 10. Don't Be Cute (Đừng tỏ ra dễ thương)
...
![](https://images.viblo.asia/27bb1f0b-834c-45c8-8d38-dceaad795b92.png)

Say what you mean *(Hãy nói những gì bạn thấy có ý nghĩa)*. Mean what you say. 
# 11. Pick One Word per Concept (Chọn một từ cho mỗi khái niệm)
...
# 13. Use Solution Domain Names (Dùng tên của miền giải pháp)
...
# 14. Use Problem Domain Names (Dùng tên của miền nghiệp vụ)
...
# 15. Add Meaningful Context (Thêm bối cảnh có ý nghĩa)
...
# 16. Don't Add Gratuitous Context (Đừng thêm những bối cảnh vô căn cứ)
