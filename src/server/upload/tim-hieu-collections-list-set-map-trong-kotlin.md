...
![](https://chercher.tech/tiles/collections-kotlin.png)
...
Với 2 kiểu collection này, ta cần phân biệt rõ ràng giữa các khái niệm read only view của mutable collection và một collection thực sự immutable.
...
### Kết luận :
> Như vậy tới đây đã xong phần Collection quan trọng trong Kotlin, các bạn chú ý học kỹ và hiểu được nó thông qua các ví dụ ở trên nhé. Cần thành thạo các Collection để có thể áp dụng tốt vào các dự án thực tế của mình..
Cảm ơn các bạn, chúc các bạn học tập thật tốt !!!
 ### Tham khảo :
* [Collections: List, Set, Map](http://kotlinlang.org/docs/reference/collections.html)
* [	Using Collection In Kotlin](https://www.c-sharpcorner.com/article/using-collection-in-kotlin/)