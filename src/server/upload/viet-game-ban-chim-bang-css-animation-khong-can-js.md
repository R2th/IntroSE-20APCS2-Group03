Mình tham khảo được cách viết game bằng css animation mà không cần sử dụng JS trên mạng nên giới thiệu cho những ai chưa biết ạ. (bow)

# Demo
{@codepen: https://codepen.io/oBuiThiHuyen/pen/BxNzLj}

# HTML
- Đầu tiên các bạn add html như bên dưới: 
...
# CSS
- Sau đó các bạn add css như sau: 
```
body{
  counter-reset:birds;
