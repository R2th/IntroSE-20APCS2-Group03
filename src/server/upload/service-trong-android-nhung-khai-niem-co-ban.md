# Training Service
Bài viết cũng đã được mình update, thêm nhiều nội dung hơn tại blog cá nhân: [Code cùng Trung](https://codecungtrung.com/). Các bạn ghé qua để học thêm kiến thức hay nhé :D

[Service trong Android – Những khái niệm cơ bản – Phần 1](https://codecungtrung.com/android/service-trong-android-phan-1/)
...
### Có các demo đơn giản để thực hành service như chơi nhạc, load file, ... Bạn hãy bắt đầu thử ngay nào :grinning::grinning::grinning:
