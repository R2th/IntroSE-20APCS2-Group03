...
![](https://images.viblo.asia/eda4a2e5-787e-4d44-976f-beaa6d78f6ea.gif)
...
Sau khi cài đặt xong,  ta di chuyển vào thư mục project  `cd login-svg-react`
Vào được thư mục project rồi thì khởi chạy ứng dung và code thôi
```
yarn start
```
...
# Thư viện cần dùng
Example đang sử dụng các thư viện bằng cách nhúng thẳng vào trang web thông qua các thẻ `csript`. Khi chuyển sang `react` ta sẽ dùng thư viện đó thông qua trình quản lý gói của `javascript ` là `npm` nhé.
