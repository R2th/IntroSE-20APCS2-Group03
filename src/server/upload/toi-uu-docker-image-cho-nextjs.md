![Background](https://images.viblo.asia/9b7efc13-015a-4865-9cde-307f275c17ac.png)
...
*Source code mình để ở [đây](https://github.com/ductnn/Dockerfile/tree/master/examples/nextjs)*
...
![blog](https://images.viblo.asia/0466c87f-3f9b-46aa-9861-daab37098934.png)
...
tạo cơ bản trước theo [basic.dockerfile](https://github.com/ductnn/Dockerfile/blob/master/examples/nextjs/blog-starter/.docker/basic.dockerfile):
...
![basic](https://images.viblo.asia/a0070caf-6d9a-4e6f-b8c7-6b62bac3f14a.png)
...
Tiếp theo, mình sẽ dùng `Multi stage` để build [dockerfile](https://github.com/ductnn/Dockerfile/blob/master/examples/nextjs/blog-starter/.docker/multistage.dockerfile).
...
cần thiết trong `package.json` và bỏ qua các `packages` trong phần `devDependencies`.
Điều này sẽ giúp giảm nhẹ hơn `node_modules` rất nhiều,

![node_modules](https://images.viblo.asia/52b6074e-a059-467b-89af-5f15719adbec.jpeg)

mình không cần lo chạy lỗi vì mình đã `build` đầy đủ từ bước trên rồi. Nhưng mình
vẫn muốn thằng `node_modules` nhẹ hơn ...

  <p align="center">
    <img src="https://images.viblo.asia/980f4a5a-25fb-43a9-99f6-1757b7ab0d0c.jpeg">
  </p>
...
![multi](https://images.viblo.asia/0e0bae65-5520-4e1e-bb80-df2df8782954.png)
...
các `files` và `packages` cần thiết để chạy, tham khảo [thêm](https://nextjs.org/docs/advanced-features/output-file-tracing)
  ...
  <p align="center">
    <img src="https://images.viblo.asia/85b7bb86-6008-43ad-b25e-b774bfaf5bdb.png" width="500">
  </p>
...
![standalone](https://images.viblo.asia/095ac94e-6897-4760-b269-c6f247614cba.png)
...
![happy](https://images.viblo.asia/c926e3d9-f2de-49d1-8dd5-eb1649e1fd10.png)
