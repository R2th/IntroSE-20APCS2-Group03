...
Đối với mỗi một bài toán Machine Learning nào đều cần phải chuẩn bị về mặt dữ liệu. Nếu không có dữ liệu thì sẽ không có gì cả :yum: Các bạn hãy thu thập các dữ liệu mặt của sếp mình, càng nhiều càng đa dạng càng tốt, Kiểu đa sắc thái như thế này là một nguồn dữ liệu rất quý giá. 
...
Chúng ta sử dụng thư viện **train_test_split** để tiến hành phân chia dữ liệu thành hai tập training và testing. Giống như bao bài toán khác :smiley::smiley::smiley:
```python 
