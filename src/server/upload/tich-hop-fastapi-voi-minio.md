...
## Cài đặt Minio
Ở đây chúng ta sử dụng Docker để cài Minio luôn vì đằng nào cũng phải dùng Docker để test Dockerfile

Tại main folder tạo folder **.docker** để lưu data từ minio vào local, file **docker-compose.yaml** và **nginx.conf**
...
Mở trình duyệt và test tại http://localhost:9000/minio/login, tài khoản là **admin/password@123** như đã setup ở file docker-compose
![](https://images.viblo.asia/0bd67369-011d-435f-bd32-180447fe789f.png)
...
![](https://images.viblo.asia/07ff384c-5432-458f-806e-0d999ea87426.png)
...
```
Upload thử file
![](https://images.viblo.asia/b6d66854-408e-4461-b19c-c3e0de57e863.png)
Check lại trên Minio, ở đây Minio đã tạo ra bucket fastapi-minio và đã upload thành công file
![](https://images.viblo.asia/0c019bc0-5b51-4200-9c4f-a3428cf5b896.png)
...
![](https://images.viblo.asia/a6f321a6-12f5-4186-a7dd-07516cc92076.png)
...
với 24-09-2021_23-34-42___buffalo-pngrepo-com.png là tên file nhận được sau khi call API Upload
![](https://images.viblo.asia/0b9648db-3d72-4dd4-9500-360800932577.png)
## Kết luận
