...
```
Tổng kết lại, không nên comment theo kiểu "què quặt" - là comment vào những đoạn code lởm. Coder nên tuân theo luật "good code > bad code + good comments".
...
Viết bất cứ thứ gì nảy ra trong đầu bạn
Đọc lại comment, và xem xem những thứ có thể cải thiện
Cải thiện chúng
...
Nguồn : https://mcusoft.files.wordpress.com/2015/04/the-art-of-readable-code.pdf