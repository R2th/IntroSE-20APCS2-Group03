...
* [Visual Studio Code](https://code.visualstudio.com/) – Một trình soạn thảo mã nguồn mở của Microsoft. Hỗ trợ sẵn TypeScipt.
* [Plugin](https://github.com/Microsoft/TypeScript-Sublime-Plugin) cho Sublime Text
* Phiên bản mới nhất của [WebStorm](https://www.jetbrains.com/webstorm/) cũng hỗ trợ TypeScipt
* Và [nhiều](https://github.com/Microsoft/TypeScript/wiki/TypeScript-Editor-Support) trình soạn thảo khác như Vim, Atom, Emacs …
...
Nhiều lập trình viên TypeScript cao cấp cũng tạo ra một file tsconfig.json chứa nhiều thiết lập. Một file cấu hình như vậy rất tiện lợi khi làm việc trên các dự án lớn có nhiều file .ts vì nó giúp tự động hóa một phần tiến trình. 
...
[(https://github.com/Microsoft/TypeScript-Sublime-Plugin)](https://code.visualstudio.com/)
