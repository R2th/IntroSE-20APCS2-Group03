## [Nguồn bài viết](https://towardsdev.com/golang-writing-memory-efficient-and-cpu-optimized-go-structs-62fcef4dbfd0)
...
Việc định nghĩa 1 cấu trúc chuẩn, phù hợp với cách mà ***data struct***  ***alignment*** thực sự mang lại hiệu quả cao...
